...
final class Version20230525124037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) DEFAULT NULL, author LONGTEXT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, prix INT NOT NULL, stock VARCHAR(13) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, genre VARCHAR(255) DEFAULT NULL, format VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
